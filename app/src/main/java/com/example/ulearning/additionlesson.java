...
public class additionlesson extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_additionlesson);

        explanationTextView = findViewById(R.id.explanationTextView);
        nextButton = findViewById(R.id.nextButton);
        finishButton = findViewById(R.id.finishButton);
        explanations = getResources().getStringArray(R.array.addition_explanations);
        ...
        finishButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(additionlesson.this, AdditionLessonCom.class);
